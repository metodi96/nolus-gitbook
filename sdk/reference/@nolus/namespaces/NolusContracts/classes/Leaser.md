...
[@nolus/nolusjs](../../../../README.md) / [NolusContracts](../README.md) / Leaser

# Class: Leaser

Defined in: [src/contracts/clients/Leaser.ts:22](https://github.com/nolus-protocol/nolus.js/blob/7b8b473d0e21c0de222dcab779a844c2037e85da/src/contracts/clients/Leaser.ts#L22)
...
> **new Leaser**(`cosmWasmClient`, `contractAddress`): `Leaser`

Defined in: [src/contracts/clients/Leaser.ts:26](https://github.com/nolus-protocol/nolus.js/blob/7b8b473d0e21c0de222dcab779a844c2037e85da/src/contracts/clients/Leaser.ts#L26)
...
### getCurrentOpenLeasesByOwner()

> **getCurrentOpenLeasesByOwner**(`ownerAddress`): `Promise`\<`string`[]\>

Defined in: [src/contracts/clients/Leaser.ts:72](https://github.com/nolus-protocol/nolus.js/blob/7b8b473d0e21c0de222dcab779a844c2037e85da/src/contracts/clients/Leaser.ts#L72)
...
The bech32 wallet address of the user (e.g. "nolus1...").

#### Returns

`Promise`\<`string`[]\>

A `Promise` resolving to an array of Nolus contract addresses, where:
...
> **getLeaserConfig**(): `Promise`\<[`LeaserConfig`](../interfaces/LeaserConfig.md)\>

Defined in: [src/contracts/clients/Leaser.ts:92](https://github.com/nolus-protocol/nolus.js/blob/7b8b473d0e21c0de222dcab779a844c2037e85da/src/contracts/clients/Leaser.ts#L92)
...
`Promise`\<[`LeaserConfig`](../interfaces/LeaserConfig.md)\>

A `Promise` resolving to a `LeaserConfig` object with the core configuration parameters.

***

### leaseQuote()

> **leaseQuote**(`downpaymentAmount`, `downpaymentCurrency`, `leaseAsset`, `max_ltd?`): `Promise`\<[`LeaseApply`](../interfaces/LeaseApply.md)\>

Defined in: [src/contracts/clients/Leaser.ts:53](https://github.com/nolus-protocol/nolus.js/blob/7b8b473d0e21c0de222dcab779a844c2037e85da/src/contracts/clients/Leaser.ts#L53)
...
The initial down payment (collateral) provided by the user, in micro-units (e.g. "15000000" = 15 USDC).

##### downpaymentCurrency

`string`

The denomination of the collateral asset (e.g. "USDC").

##### leaseAsset

`string`

The asset to be acquired via leverage (e.g. "OSMO", "ALL_BTC", etc.).

##### max\_ltd?

`number`

Optional. Maximum loan-to-downpayment ratio (LTD), in permilles (e.g. 1500 = 150%). Defaults to 1500.

#### Returns

`Promise`\<[`LeaseApply`](../interfaces/LeaseApply.md)\>

A `Promise` resolving to a `LeaseApply` object containing:
...
> **openLease**(`nolusWallet`, `leaseCurrency`, `fee`, `max_ltd?`, `fundCoin?`): `Promise`\<`ExecuteResult`\>

Defined in: [src/contracts/clients/Leaser.ts:119](https://github.com/nolus-protocol/nolus.js/blob/7b8b473d0e21c0de222dcab779a844c2037e85da/src/contracts/clients/Leaser.ts#L119)
...
The asset to be acquired via leverage (e.g. "ATOM").

##### fee

`number` \| `StdFee` \| `"auto"`

The transaction fee (can be a `StdFee` object, `auto`, or a numeric gas estimate).

##### max\_ltd?

`number`

Optional maximum loan-to-downpayment ratio in permilles (default is 1500 which corresponds to 2.5x of leverage).

##### fundCoin?

`Coin`[]

The provided collateral amount as an array of `Coin` objects, typically 1 element.

#### Returns

`Promise`\<`ExecuteResult`\>

A `Promise` resolving to an `ExecuteResult` object, containing:
...
> **simulateOpenLeaseTx**(`nolusWallet`, `leaseCurrency`, `max_ltd?`, `fundCoin?`): `Promise`\<`any`\>

Defined in: [src/contracts/clients/Leaser.ts:142](https://github.com/nolus-protocol/nolus.js/blob/7b8b473d0e21c0de222dcab779a844c2037e85da/src/contracts/clients/Leaser.ts#L142)
...
The user's connected wallet instance.
...
Optional maximum loan-to-downpayment ratio in permilles (default is 1500).

##### fundCoin?

`Coin`[]

The collateral amount as an array of `Coin` objects, typically 1 element.

#### Returns

`Promise`\<`any`\>

A `Promise` resolving to a simulation result object containing:
